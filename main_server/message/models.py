...
class Message(models.Model):
    ...
    sent_by = models.ForeignKey(GroupMember, on_delete=models.CASCADE, related_name='messages')
    sent_at = models.DateTimeField(auto_now_add=True)
    parent = models.ForeignKey('self', on_delete=models.CASCADE, related_name='children', null=True, blank=True)
    recieved_by = models.ForeignKey(GroupMember, on_delete=models.CASCADE, related_name='recieved_messages', blank=True, null=True)
